      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
                  ...
                  >
                    {file.thumbnail_url && (
                      <img
                        ...
                        alt={file.title}
                        className="h-10 w-10 flex-shrink-0 rounded border bg-muted object-contain"
                      />
                    )}
          ...
          <div className="flex items-start gap-2 text-sm text-muted-foreground bg-muted p-4 rounded-lg">
            ...
            <p>
              Prices are estimated based on material usage and machine time.
              Final price may vary slightly depending on post-processing
              requirements.
            </p>
          </div>
        </div>
