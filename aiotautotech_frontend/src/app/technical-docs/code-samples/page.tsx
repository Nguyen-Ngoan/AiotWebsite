...
function CodeSampleCard({ doc }: { doc: TechnicalDoc }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="flex h-32 w-full items-center justify-center bg-gray-50">
        <CodeBracketIcon className="h-16 w-16 text-gray-300" />
      </div>
...
export default function CodeSamplesLibraryPage() {
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Breadcrumb" className="mb-4">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li className="font-medium text-gray-800">Code mẫu</li>
            </ol>
          </nav>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link
              href="/admin/technical-docs/new?doc_type=github_repo"
          ...
          <p className="mt-2 text-lg text-gray-600">
            Các đoạn code mẫu và ví dụ cho dự án DIY và tự động hóa.
          </p>
          ...
          <div className="mt-8">
            ...
            {!isLoading && !error && docs.length === 0 && (
              <p className="text-gray-500">
                Chưa có code mẫu nào trong thư viện.
              </p>
            )}
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {docs.map((doc) => (
                <CodeSampleCard key={doc.id} doc={doc} />
              ))}
            </div>
