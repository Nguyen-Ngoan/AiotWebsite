    ...
    return (
      <div className="min-h-screen bg-apple-gray dark:bg-apple-gray-dark dark:text-apple-text-dark">
        ...
        <main className="pt-20 flex items-center justify-center">
          <p className="text-sm text-gray-600 dark:text-gray-300">Đang tải dữ liệu bài viết...</p>
        </main>
        <Footer />
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-apple-gray dark:bg-apple-gray-dark dark:text-apple-text-dark">
        ...
        <main className="pt-20 flex flex-col items-center justify-center px-4 text-center">
          <h1 className="mb-2 text-xl font-semibold text-red-600">KHÔNG CHỈNH SỬA ĐƯỢC BÀI VIẾT</h1>
          <p className="mb-4 text-sm text-gray-600 dark:text-gray-300 max-w-md">{error || "Không tìm thấy dữ liệu bài viết."}</p>
        </main>
        <Footer />
      </div>
    );
    ...
    <div className="min-h-screen bg-apple-gray dark:bg-apple-gray-dark dark:text-apple-text-dark">
      ...
      <main className="pt-20 pb-16">
        <div className="mx-auto max-w-4xl px-4">
          <h1 className="mb-2 text-2xl font-semibold text-gray-900 dark:text-gray-100">Chỉnh sửa bài viết</h1>
          <p className="mb-6 text-sm text-gray-600 dark:text-gray-300">
            Cập nhật nội dung cho bài: <span className="font-semibold">{post.title}</span>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-[#111] dark:text-gray-100" placeholder="Tiêu đề bài viết" />
            </div>
            ...
            <div className="pt-4 flex gap-3">
              <button type="submit" disabled={saving} className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-blue-500 disabled:opacity-60">
                {saving ? "Đang lưu..." : "Lưu thay đổi"}
              </button>

              <button type="button" onClick={() => router.push(`/blog/${id}`)} className="inline-flex items-center rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-800 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-[#222]">
                Huỷ
              </button>
            </div>
          </form>
