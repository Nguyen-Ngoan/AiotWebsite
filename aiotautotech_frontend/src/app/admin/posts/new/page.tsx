      ...
      <main className="pt-20 pb-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <p className="mb-6 text-sm text-gray-600 dark:text-gray-300">
            Viết bài blog về ESP32, Stepper, IoT, trục tuyến tính… Nội dung sẽ
            được lưu trên Firestore và hiển thị ở phần Blog.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ví dụ: Điều khiển Stepper bằng ESP32 – phần 1"
              />
            </div>
            ...
            <div>
              ...
              <div className="mt-3 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-700 dark:border-gray-700 dark:bg-[#141414] dark:text-gray-200">
                <div className="mb-1 font-medium">
                  Symbol thường dùng (click để chèn vào nội dung gửi lên
                  Firestore):
                </div>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="rounded border border-gray-300 bg-white px-2 py-1 text-xs font-semibold text-gray-800 hover:bg-gray-100 dark:border-gray-600 dark:bg-[#111] dark:text-gray-100 dark:hover:bg-[#222]"
                    >
                      {sym}
                    </button>
                  ))}
                ...
                <p className="mt-2 text-[11px] text-gray-500 dark:text-gray-400">
                  Dùng cho các ký hiệu điện – điện tử: nhiệt độ, điện trở,
                  micro, sai số, mũ 2, mũ 3…
                </p>
              </div>

              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                Bạn có thể dùng tiêu đề (H1–H3), danh sách, in đậm, in nghiêng
                và chèn ảnh (bằng URL). Sau này có thể nâng cấp thêm chức năng
                upload ảnh lên GCS.
              </p>
            </div>
