  ...
  return (
    ...
    >
      <div className="flex flex-col">
        {/* HÀNG TRÊN: LOGO + ICONS — nền xanh brand, full width */}
        <div className="w-full bg-[#1d67b0]">
          <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2 md:px-6 md:py-3">
        ...
        {/* HÀNG DƯỚI: TOP NAVIGATION DESKTOP — nền trùng mặt nút HOME (black/10 trên xanh) */}
        <div className="hidden w-full bg-[#1d67b0] md:block">
                ...
                <Link
                  ...
                  className={
                    item.href === '/admin'
                      ...
                      : 'group shrink-0 px-5 py-2 transition-colors duration-200 hover:bg-black/20 sm:px-6 lg:px-7'
                  }
                >
        ...
        {/* MOBILE MENU — nền xanh cùng hàng logo khi mở */}
        <div className="w-full bg-[#1d67b0] md:hidden">
