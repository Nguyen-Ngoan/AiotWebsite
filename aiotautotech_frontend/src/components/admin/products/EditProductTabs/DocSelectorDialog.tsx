// src/components/admin/products/EditProductTabs/DocSelectorDialog.tsx
'use client';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-3">
        ...
        <p className="text-xs text-gray-500 mt-1 font-mono bg-gray-100 rounded px-1 py-0.5 inline-block">
          {doc.doc_type}
        </p>
        <button
          type="button"
...
export default function DocSelectorDialog({
  isOpen,
  onClose,
  onSelect,
  existingDocIds,
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const fetchDocs = async () => {
        try {
          let url = getApiUrl('/technical-docs/');
          if (docType) {
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {isLoading && <p>Loading document library...</p>}
