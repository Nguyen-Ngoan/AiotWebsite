...
export default function BundleTab({ form }: BundleTabProps) {
  ...
  return (
    <div className="space-y-3 text-sm text-gray-600">
      <p>Tab này dành cho cấu hình kit / bundle (nhiều sản phẩm con trong một gói). Backend hiện tại chưa lưu cấu trúc này trong Firestore, nên phần này tạm thời là ghi chú / placeholder.</p>
      <p>
        Khi bạn muốn dùng thật, ta sẽ thêm:
        <br />- Mảng <code>bundleItems</code> trong <code>ProductFormState</code>
